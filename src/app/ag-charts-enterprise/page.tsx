...
import AGChartsEnterprise from './AGChartsEnterprise'
...
function Page() {
  ...
  const [selectedTab, setSelectedTab] = useSyncedTab('tabs:ag-charts-enterprise')
  ...
  useEffect(() => {
    handleLibraryChange('ag-charts-enterprise');
  }, []);

  return (
    <>
      <TabsContainer selectedTab={selectedTab} setSelectedTab={setSelectedTab} />
      {selectedTab === 'charts' && <AGChartsEnterprise />}
