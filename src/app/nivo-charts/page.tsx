...
const dashboardInfoDatas = {
    ...
    availableFeatures: [
      ...
      { feature: "Export Options (CSV)", supported: true },
...
function Page() {
  ...
  const [selectedTab, setSelectedTab] = useSyncedTab('tabs:nivo')
